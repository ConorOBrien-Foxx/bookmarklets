...
Foxx.func1 = function(a){Foxx.style.innerHTML="*{cursor:url("+a.src+"),default;}";
document.getElementsByTagName("head")[0].appendChild(Foxx.style);
document.getElementById("ConorOBrienFoxxCursorBox").outerHTML="";}
Foxx.popup.i2 = "Foxx.func1(this.src);"; // wip
Foxx.popup.i = "<img src=\"https://cloud.githubusercontent.com/assets/12823013/8146717/fe213118-1216-11e5-8eb7-6f5f8914b0f5.png\" onclick=\""+Foxx.popup.i2+"\" >"
